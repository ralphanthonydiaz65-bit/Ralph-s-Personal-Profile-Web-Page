...
<ol type="I">
    ...
    <li>(Sleeping)</li>
    <li>(Eating)</li>
    <li>(Going out if I get bored)</li>
...
<ol reversed>
    ...
    <li>(No need to pressure myself to be successful in life)</li>
    <li>(Manage the time)</li>
    <li>(Be patient)</li>
    <li>(Clock only runs when the right time is come)</li>
</ol>

## About Me
Hi! I'm Ralph, a passionate learner and aspiring developer. I believe in continuous growth, hard work, and maintaining a balance between my personal and professional life. I value family, faith, and t[...]
